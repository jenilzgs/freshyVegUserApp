...
import 'package:flutter_grocery/features/auth/screens/biometric_screen.dart';
...
class RouteHelper {
  ...
  static String getBiometricRoute() => biometric;
  ...
  static final Handler _loginBiometric = Handler(handlerFunc: (BuildContext? context, Map<String, dynamic> params) => _routeHandler(child: const BiometricScreen()));
  ...
  static void setupRouter(){
    ...
    router.define(biometric, handler: _loginBiometric, transitionType: TransitionType.fadeIn);
